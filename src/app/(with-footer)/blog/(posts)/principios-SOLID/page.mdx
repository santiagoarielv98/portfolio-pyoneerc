...
export const metadata = {
	title: "The People Behind RDR2",
	description:
		"Information about the role distribution, seniority, and breakdowns per department of the development team behind RDR2.",
...
## This is an example of a Markdown image
